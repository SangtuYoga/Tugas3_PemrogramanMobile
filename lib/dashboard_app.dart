...
import 'package:flutter_sangtu_tugas3/ui/home.dart' as home;
import 'dart:ui';
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          new GestureDetector(
            ...
            child: MenuBox(nama: "List Produk", gambar: "keranjang.png"),
          ),
          Text(" ",
          ...
          new GestureDetector(
            ...
            child: MenuBox(nama: "Transaksi", gambar: "transaksi.jpg"),
          ),
          Text(" ",
              textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0)),
          new GestureDetector(
            ...
            child: MenuBox(nama: "About", gambar: "about.png"),
          ),
        ],
      ),
    );
